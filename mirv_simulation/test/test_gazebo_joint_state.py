...
##############################################################################
##############################################################################
class TestEncoderCommon(unittest.TestCase):
    ##############################################################################
    ##############################################################################
    # def set_up(self):
    ##############################################################################
    def __init__(self, *args):
        ...
        self.set_up()
        super(TestEncoderCommon, self).__init__(*args)
...
##############################################################################
##############################################################################
class TestEncoderValid(TestEncoderCommon):
    ##############################################################################
    ##############################################################################
...
if __name__ == '__main__':
    rospy.loginfo("-I- test_encoders started")
    rospy.loginfo("-D- sys.argv: %s" % str(sys.argv))
    rostest.rosrun(PKG, 'test_encoders_valid', TestEncoderValid, sys.argv)