...
def log_packages_neptune(neptune_logger):
    ...
    neptune.log_table(name="packages", table=packages_df, experiment=neptune_logger.experiment)
...
def log_mapping_neptune(mapping: dict, neptune_logger):
    ...
    neptune.log_table(name="mapping", table=mapping_df, experiment=neptune_logger.experiment)
...
def log_model_neptune(
    ...
    # with open("/home/nvidia/Documents/piLitDetectionTest.pcl", "w") as f:
    torch.save(model.state_dict(), "/home/nvidia/Documents/piLitDetectionTest.pt")
